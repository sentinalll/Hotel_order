...
<div class="navbar">
    <div class="navbar-inner">
        ...
        <ul class="nav">
            ...
            <li class="divider-vertical"></li>
            <li class="active"><a  href="./controller?command={archivedOrderAdmin}">${currentLanguage.getString("archived")}</a></li>
            <li class="divider-vertical"></li>
                ...
                <tbody> 
                    ...
                    <c:forEach  items="${allorder.iterator()}" var="order" >
                        ...
                        <tr>  
                            ...
                            <td><a href="./controller?command={deleteThisOrderAdmin}&order=${order.orderId}"><i class="icon-remove-sign"></i></a>
                        </tr>  
                    </c:forEach>  
                </tbody>  
            </table> 
